...
public class MainActivity extends Activity
{
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            try 
            {
                Message msg = Message.obtain(null, ActivityCaptureService.MSG_REGISTER_CLIENT);
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		 ...
		 String[] columns = new String[]
				 {
				 	db.COLUMN_DATE,
				    db.COLUMN_UNKNOWN,
				    db.COLUMN_IN_VEHICLE,
				    db.COLUMN_ON_BICYCLE,
				    db.COLUMN_ON_FOOT,
				    db.COLUMN_STILL,
				    db.COLUMN_TILTING
				  };
		...
		dbAdapterC = new SimpleCursorAdapter(this, R.layout.item_lv,c,columns,to);
	...
	public void startService(View view) 
	{
		if(!isServiceRunning)
		{
			Intent i = new Intent(getBaseContext(), ActivityCaptureService.class);
			startService(i);
		...
		{
			doUnbindService();
			stopService(new Intent(getBaseContext(), ActivityCaptureService.class));
	...
	void doBindService() {
        bindService(new Intent(this, ActivityCaptureService.class), mConnection, Context.BIND_AUTO_CREATE);
        mIsBound = true;
    }
	...
	void doUnbindService() {
        if (mIsBound) {
            ...
            if (mService != null) {
                try {
                    Message msg = Message.obtain(null, ActivityCaptureService.MSG_UNREGISTER_CLIENT);
                    msg.replyTo = mMessenger;
                    mService.send(msg);
                }
                catch (RemoteException e) {
	...
	public void exportDB(View view)
	{
		...
		String currentDBPath = "/data/"+ "project.praktikum.recognition" +"/databases/"+ "MyDBName.db";
	...
	private void sendMail(File outFile) {
        ...
        sendIntent.putExtra(android.content.Intent.EXTRA_SUBJECT,"Project Praktikum");
